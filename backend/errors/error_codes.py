...
class ErrorCode(str, Enum):
    ...
    QUIZ_CHALLENGE_PAST_SESSION = "QUIZ_CHALLENGE_PAST_SESSION"
...
ERROR_DEFAULTS = {
    ...
    ErrorCode.STUDENT_NOT_FOUND: {"message": "This student could not be found.", "http_status": 404},
    ...
    ErrorCode.QUIZ_CHALLENGE_PAST_SESSION: {"message": "Only quizzes from the current academic session can be challenged.", "http_status": 400},
