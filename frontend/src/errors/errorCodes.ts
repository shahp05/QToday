...
export const ERROR_DEFAULTS: Record<ErrorCodeValue, ErrorDefault> = {
  ...
  INCORRECT_CURRENT_PASSWORD: { message: "Your current password is incorrect.", httpStatus: 400 },
  PASSWORD_POLICY_VIOLATION: { message: "Your new password does not meet the password policy.", httpStatus: 400 },
  ...
  STUDENT_NOT_FOUND: { message: "This student could not be found.", httpStatus: 404 },
  ...
  QUIZ_ALREADY_PENDING: { message: "You already have a quiz on this topic awaiting a score. Play again once it's scored.", httpStatus: 409 },
  QUIZ_CHALLENGE_PAST_SESSION: { message: "Only quizzes from the current academic session can be challenged.", httpStatus: 400 },
  ...
  INVALID_LOGIN_ID: { message: "This login ID could not be found.", httpStatus: 404 },
  STUDENT_CANNOT_SELF_RESET: { message: "Students cannot reset their own password this way. Ask a teacher or parent to reset it.", httpStatus: 400 },
  NOT_A_STUDENT_ACCOUNT: { message: "Only student accounts can raise a password reset request this way.", httpStatus: 400 },
  RESET_REQUEST_NOT_FOUND: { message: "This reset request could not be found or has already been resolved.", httpStatus: 404 },
  SESSION_TARGET_INVALID: { message: "This upload's target session is not valid for this school.", httpStatus: 400 },
